...
- [cyberDeals](/cyberdeals) — onchain deal tooling.
  - [cyberRaise](/cyberdeals/cyberraise) — deal flow and agreement execution.
  - [LeXcheX](/cyberdeals/lexchex)
  - [MetaVesT](/cyberdeals/metavest) — vesting and token lockup toolkit for BORGs and cyberCORPs.
  - [LeXscroW](/cyberdeals/lexscrow) — ownerless condition-based escrow for BORGs and cyberCORPs.
