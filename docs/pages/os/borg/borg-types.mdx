...
<CardGrid>
  <Card title="Borg Implant" link="/os/borg/borg-implants/borg-implant" icon={<LuShield />}>
    <span>Borg Implants are SAFE Modules included in MetaLeX OS and designed to make SAFEs function as parts of BORGs.</span>
  </Card>
...
<Callout>
  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla nec nunc euismod, elit nisi luctus nunc, euismod euismod nisi luctus nunc.
</Callout>
