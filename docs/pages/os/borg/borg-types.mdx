...
<CardGrid>
  ...
  <Card title=">./devBORG" link="/os/borg/borg-types/devborg">
    <span>
      devBORGs run the 'development operations' adjacent to a DAO or protocol. These include managing the development of the protocol, managing the development of the DAO, and managing the development of the community.
    </span>
  </Card>
