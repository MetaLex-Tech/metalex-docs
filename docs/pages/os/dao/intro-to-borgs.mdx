...
# Intro to BORGS & BORG Design Principles

‘BORGs’ is short for ‘cyBernetic ORGanizationS’: BORGs are cybernetic entities. Since Delphi Labs’ seminal [article](https://delphilabs.medium.com/assimilating-the-borg-a-new-cryptolegal-framework-for-dao-adjacent-entities-569e54a43f83) on BORGs in 2023, the concept has taken off, with many DAOs adopting BORGs or BORG-inspired solutions and the 'BORG' term becoming a fixture of DAO governance dialogues. 
