...
3. **Check your permissions**  
   The interface will show whether you can propose transactions, approve them, or both. Your permissions are based on your onchain role (set in `BorgAuth`).
...
5. **Track execution**  
   Once the required approvals are collected, the transaction executes automatically onchain.
