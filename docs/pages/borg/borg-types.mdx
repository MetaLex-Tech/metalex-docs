...
- **Example:** A DAO funds open-source tools via grantsBORG, with all approvals and payouts tracked onchain.

## ipBORG
Holds and manages intellectual property (trademarks, copyrights, patents).  
- Enables onchain licensing and transparent ownership changes.
...
- Runs revenue-generating activities onchain with automated compliance.
